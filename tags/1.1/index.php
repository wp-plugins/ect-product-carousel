...
$list_prod=get_option('ect_prod_sett_list_prod');
$vi=get_option('ect_prod_sett_visible_prod');
$Q=mysql_query("select p1.pID,p1.pName,p1.pSection,p2.imageSrc from ".$db_name.".products as p1 inner join ".$db_name.".productimages as p2 on p1.pID=p2.imageProduct $inn where p2.imageType=0 and p1.pDisplay=1 and p1.pInStock>0 $cond limit $list_prod ");
